  ...
  return <SafeAreaView style={[styles.safe, screen === 'rooms' && styles.safeRooms]}>
    ...
    <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={styles.page}>
      {screen === 'home' && <>
        ...
        <ImageBackground source={{ uri: 'https://raw.githubusercontent.com/tahadiplus/tahadi-plus-app/feature/iphone-games-okey/assets/zagros-citadel.jpg' }} style={styles.hero}
      ...
      {screen === 'rooms' && <>
        ...
        <ImageBackground source={{ uri: 'https://raw.githubusercontent.com/tahadiplus/tahadi-plus-app/feature/iphone-games-okey/assets/zagros-citadel.jpg' }} style={styles.roomsBanner}
      ...
      {screen === 'konkan' && <>{header('کۆنکان')}
        <ImageBackground source={{ uri: 'https://raw.githubusercontent.com/tahadiplus/tahadi-plus-app/feature/iphone-games-okey/assets/zagros-citadel.jpg' }} style={styles.konkanBanner}
          imageStyle={styles.heroImage} resizeMode="cover">
